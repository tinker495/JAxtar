...
class LightsOutNeuralHeuristic(LightsOutPreProcessMixin, NeuralHeuristicBase):
    is_fixed: bool = True
...
class LightsOutConvNeuralHeuristic(LightsOutConvPreProcessMixin, NeuralHeuristicBase):
    network_model = Model
