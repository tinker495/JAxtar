...
class RubiksCubeMHCNeuralQ(RubiksCubeNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, model=MHCResMLPModel, **kwargs)


class RubiksCubeMHCHLGNeuralQ(RubiksCubeNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
...
class RubiksCubeRandomMHCNeuralQ(RubiksCubeRandomNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, model=MHCResMLPModel, **kwargs)


class RubiksCubeRandomMHCHLGNeuralQ(RubiksCubeRandomNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, model=MHCHLGResMLPModel, **kwargs)
