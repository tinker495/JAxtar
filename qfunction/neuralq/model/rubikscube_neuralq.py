...
class RubiksCubeMoENeuralQ(RubiksCubeNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, model=MoEResMLPModel, **kwargs)


class RubiksCubeHLGMoENeuralQ(RubiksCubeNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
...
class RubiksCubeRandomMoENeuralQ(RubiksCubeRandomNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, model=MoEResMLPModel, **kwargs)


class RubiksCubeRandomHLGMoENeuralQ(RubiksCubeRandomNeuralQ):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, model=HLGMoEResMLPModel, **kwargs)
