...
class _CubieSpecs:
    corner_faces: chex.Array
    corner_rows: chex.Array
    corner_cols: chex.Array
    edge_faces: chex.Array
    edge_rows: chex.Array
    edge_cols: chex.Array
...
class _RubiksCubeCubieNeuralQBase(NeuralQFunctionBase):
    ...
    def _cubie_encoding(
        ...
        edge_lookup = jnp.stack([target_edge_colors, target_edge_colors[:, ::-1]], axis=1)
...
class RubiksCubeNeuralQ(_RubiksCubeCubieNeuralQBase):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, **kwargs)


class RubiksCubeRandomNeuralQ(_RubiksCubeCubieNeuralQBase):
    def __init__(self, puzzle: RubiksCube, **kwargs):
        super().__init__(puzzle, **kwargs)
