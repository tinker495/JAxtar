...
puzzle_bundles: Dict[str, PuzzleBundle] = {
    ...
    "rubikscube": PuzzleBundle(
        ...
        heuristic_spr_config=NeuralCallableConfig(
            ...
            path_template="heuristic/neuralheuristic/spr_model/params/rubikscube_{size}.pkl",
        ),
        q_function_spr_config=NeuralCallableConfig(
            callable=RubiksCubeSPRNeuralQ,
            path_template="qfunction/neuralq/spr_model/params/rubikscube_{size}.pkl",
        ),
    ),
    ...
    "rubikscube_world_model": PuzzleBundle(
        ...
        heuristic_spr_config=NeuralCallableConfig(
            ...
            path_template="heuristic/neuralheuristic/spr_model/params/rubikscube_world_model_None.pkl",
        ),
        q_function_spr_config=NeuralCallableConfig(
            callable=WorldModelSPRNeuralQ,
            path_template="qfunction/neuralq/spr_model/params/rubikscube_world_model_None.pkl",
        ),
    ),
    ...
    "rubikscube_world_model_optimized": PuzzleBundle(
        ...
        heuristic_spr_config=NeuralCallableConfig(
            callable=WorldModelSPRNeuralHeuristic,
            path_template="heuristic/neuralheuristic/spr_model/params/rubikscube_world_model_optimized_None.pkl",
        ),
        q_function_spr_config=NeuralCallableConfig(
            callable=WorldModelSPRNeuralQ,
            path_template="qfunction/neuralq/spr_model/params/rubikscube_world_model_optimized_None.pkl",
        ),
    ),
    ...
    "sokoban_world_model": PuzzleBundle(
        ...
        heuristic_spr_config=NeuralCallableConfig(
            callable=WorldModelSPRNeuralHeuristic,
            path_template="heuristic/neuralheuristic/spr_model/params/sokoban_world_model_None.pkl",
        ),
        q_function_spr_config=NeuralCallableConfig(
            callable=WorldModelSPRNeuralQ,
            path_template="qfunction/neuralq/spr_model/params/sokoban_world_model_None.pkl",
        ),
    ),
    "sokoban_world_model_optimized": PuzzleBundle(
        ...
        heuristic_spr_config=NeuralCallableConfig(
            callable=WorldModelSPRNeuralHeuristic,
            path_template="heuristic/neuralheuristic/spr_model/params/sokoban_world_model_optimized_None.pkl",
        ),
        q_function_spr_config=NeuralCallableConfig(
            callable=WorldModelSPRNeuralQ,
            path_template="qfunction/neuralq/spr_model/params/sokoban_world_model_optimized_None.pkl",
        ),
        eval_options=EvalOptions(
            batch_size=100,
        ),
