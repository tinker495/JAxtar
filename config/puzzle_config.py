...
puzzle_heuristic_dict_nn: dict[str, callable] = {
    ...
    if reset
        ...
        puzzle, "heuristic/neuralheuristic/model/params/rubikscube_world_model_optimized_None_brn_dytan.pkl"
    ),
    ...
    if reset
        ...
        puzzle, "heuristic/neuralheuristic/model/params/sokoban_world_model_None_brn_dytan.pkl"
    ),
    "sokoban_world_model_optimized": lambda n, puzzle, reset: WorldModelNeuralHeuristic(puzzle)
    if reset
    else WorldModelNeuralHeuristic.load_model(
        puzzle, "heuristic/neuralheuristic/model/params/sokoban_world_model_optimized_None_brn_dytan.pkl"
    ),
}
...
puzzle_q_dict_nn: dict[str, callable] = {
    ...
    if reset
    else SlidePuzzleNeuralQ.load_model(puzzle, f"qfunction/neuralq/model/params/n-puzzle_{n}_brn_dytan.pkl"),
    "lightsout": lambda n, puzzle, reset: LightsOutNeuralQ(puzzle)
    if reset
    else LightsOutNeuralQ.load_model(puzzle, f"qfunction/neuralq/model/params/lightsout_{n}_brn_dytan.pkl"),
    "rubikscube": lambda n, puzzle, reset: RubiksCubeNeuralQ(puzzle)
    if reset
    else RubiksCubeNeuralQ.load_model(puzzle, f"qfunction/neuralq/model/params/rubikscube_{n}_brn_dytan.pkl"),
    "sokoban": lambda n, puzzle, reset: SokobanNeuralQ(puzzle)
    if reset
    else SokobanNeuralQ.load_model(puzzle, f"qfunction/neuralq/model/params/sokoban_{n}_brn_dytan.pkl"),
    "rubikscube_world_model": lambda n, puzzle, reset: WorldModelNeuralQ(puzzle)
    if reset
    else WorldModelNeuralQ.load_model(
        puzzle, "qfunction/neuralq/model/params/rubikscube_world_model_None_brn_dytan.pkl"
    ),
    ...
    if reset
        ...
        puzzle, "qfunction/neuralq/model/params/rubikscube_world_model_optimized_None_brn_dytan.pkl"
    ),
    ...
    if reset
        ...
        puzzle, "qfunction/neuralq/model/params/sokoban_world_model_None_brn_dytan.pkl"
    ),
    "sokoban_world_model_optimized": lambda n, puzzle, reset: WorldModelNeuralQ(puzzle)
    if reset
    else WorldModelNeuralQ.load_model(
        puzzle, "qfunction/neuralq/model/params/sokoban_world_model_optimized_None_brn_dytan.pkl"
    ),
}
