...
puzzle_zeroshot_q_dict_nn: dict[str, callable] = {
    "rubikscube": lambda n, puzzle, reset: RubiksCubeZeroshotQ(
        puzzle,
        path=f"qfunction/zeroshotq/model/params/rubikscube_{n}.pkl",
        init_params=reset,
    ),
    "rubikscube-random": lambda n, puzzle, reset: RubiksCubeZeroshotQ(
        puzzle,
        path=f"qfunction/zeroshotq/model/params/rubikscube_{n}.pkl",
        init_params=reset,
    ),
    "room": lambda n, puzzle, reset: RoomZeroshotQ(
        puzzle,
        path=f"qfunction/zeroshotq/model/params/room_{n}.pkl",
        init_params=reset,
    ),
}
