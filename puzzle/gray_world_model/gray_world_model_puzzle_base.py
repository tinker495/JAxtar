...
class GrayWorldModel(nn.Module):
    latent_shape: tuple[int, ...]
    action_size: int
...
class GrayWorldModelPuzzleBase(Puzzle):
    ...
    class SolveConfig:
        ...
        TargetState: "GrayWorldModelPuzzleBase.State"
    ...
    def __init__(
        ...
        **kwargs,
        ...
        class total_model(nn.Module):
            ...
            def flipped(self, latent, training=False):
            ...
            def train_info(self, data, next_data, training=True):
                ...
                flipped = self.flipped(rounded_latent, training)
    ...
    def get_string_parser(self):
        def parser(
            state: "GrayWorldModelPuzzleBase.State",
            solve_config: "GrayWorldModelPuzzleBase.SolveConfig" = None,
            **kwargs,
        ):
            if STR_PARSE_IMG:
                state_img = state.img(
    ...
    def get_default_gen(self) -> callable:
        ...
        def default_gen():
            ...
            return GrayWorldModelPuzzleBase.State(latent=latent_uint8)
