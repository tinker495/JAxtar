...
def train_option(func: callable) -> callable:
    ...
    @click.option("--dataset_batch_size", type=int, default=524288)  # 8192 * 64
    @click.option("--dataset_minibatch_size", type=int, default=8192)  # 128 * 16
    @click.option("--train_minibatch_size", type=int, default=8192)  # 128 * 16
