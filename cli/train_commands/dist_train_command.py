    ...
    for i in pbar:
        ...
        if i % 1000 == 0 and i != 0:
            ...
            heuristic.save_model(
                f"heuristic/neuralheuristic/model/params/{puzzle_name}_{puzzle_size}_brn.pkl"
            )
    ...
    **kwargs,
    ...
    for i in pbar:
        ...
        if i % 1000 == 0 and i != 0:
            ...
            qfunction.save_model(f"qfunction/neuralq/model/params/{puzzle_name}_{puzzle_size}_brn.pkl")
