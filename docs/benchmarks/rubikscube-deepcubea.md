...
| A* | Diffusion Distance - 14.7M params(int8) | 100% / 57.40% | 1.052s | 1.81M | 21.55 | 0.893 | 0.952 | |
| A* | Diffusion Distance - 4M params | 100% / 47.60% | 0.743s | 1.84M | 21.78 | 0.886 | 0.949 | |
| A* | Diffusion Distance - 4M params(int8) | 100% / 46.90% | 0.634s | 1.84M | 21.80 | 0.888 | 0.950 | |
...
| A* Deferred | Diffusion Distance - 14.7M params(int8) | 100% / 57.50% | 1.017s | 186K | 21.55 | 0.893 | 0.952 | |
| A* Deferred | Diffusion Distance - 4M params | 100% / 47.40% | 0.657s | 189K | 21.79 | 0.886 | 0.949 | |
| A* Deferred | Diffusion Distance - 4M params(int8) | 100% / 46.90% | 0.591s | 189K | 21.80 | 0.888 | 0.950 | |
...
| Q* | Diffusion Distance warmup - 14.7M params(int8) | 100% / 51.50% | 0.462s | 187K | 21.67 | 0.917 | 0.961 | |
| Q* | Diffusion Distance warmup - 4M params | 100% / 42.20% | 0.405s | 190K | 21.93 | 0.911 | 0.958 | |
| Q* | Diffusion Distance warmup - 4M params(int8) | 100% / 40.70% | 0.406s | 190K | 21.97 | 0.910 | 0.958 | |
| Beam Search | Diffusion Distance - 14.7M params | 100% / 57.30% | 0.854s | 187K | 21.55 | 0.897 | 0.954 | |
| Beam Search | Diffusion Distance - 14.7M params(int8) | 100% / 56.20% | 0.620s | 187K | 21.57 | 0.893 | 0.952 | |
| Beam Search | Diffusion Distance - 4M params | 100% / 46.50% | 0.308s | 189K | 21.82 | 0.886 | 0.949 | |
| Beam Search | Diffusion Distance - 4M params(int8) | 100% / 45.40% | 0.223s | 190K | 21.83 | 0.888 | 0.950 | |
| Q-Beam Search | Diffusion Distance warmup - 14.7M params | 100% / 49.40% | 0.096s | 145K | 21.73 | 0.918 | 0.962 | |
| Q-Beam Search | Diffusion Distance warmup - 14.7M params(int8) | 100% / 49.10% | 0.076s | 145K | 21.73 | 0.917 | 0.961 | |
| Q-Beam Search | Diffusion Distance warmup - 4M params | 100% / 37.10% | 0.073s | 146K | 22.08 | 0.911 | 0.958 | |
| Q-Beam Search | Diffusion Distance warmup - 4M params(int8) | 100% / 37.60% | 0.075s | 147K | 22.08 | 0.910 | 0.958 | |
